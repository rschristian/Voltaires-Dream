'''
MISSION LOC GENERATOR - by Isildur

Instructions -
-- there are 2 txt files that need inputted text to function - unlocalized_names and localized_names

-- in unlocalized_names, put the unlocalized name for each mission in code on separate lines e.g:
vn_eng_consolidate_our_rule
vn_eng_fortify_england
...
def output_text():
    ...
    while line_num < line_count:
        ...
        print(" " + segment1 + '_title: ' + '"' + segment2 + '"')
        print(" " + segment1 + '_desc: ' + '""')
